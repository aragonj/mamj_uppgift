...
namespace MAMJ_uupgift
{
    ...
    public partial class Form1 : Form
    {
        ...
        string nyttomaximering = "select top 10 (overall_satisfaction/price) as nyttomaximering, price, latitude, longitude from COUNTRY where accommodates = NUMBER and overall_satisfaction != 0 and price != 0 ORDER BY nyttomaximering DESC";
